document.addEventListener('DOMContentLoaded', function () {
    ...
    function verifyCaptcha() {
        ...
        if (inputText === captchaText.toLowerCase()) {
            ...
            captchaStatus.textContent = 'Ingrese todos los caracteres!';
            captchaStatus.style.color = 'red';
        } else {
            captchaStatus.textContent = 'Captcha incorrecto. Por favor, inténtalo de nuevo!';
            captchaStatus.style.color = 'red';
        }
        setTimeout(() => {
            captchaStatus.textContent = 'Estado: INACTIVO';
